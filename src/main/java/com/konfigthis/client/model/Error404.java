 ...
 */
@ApiModel(description = "The server has not found anything matching the request URI. This either means that the URI is incorrect or the resource is not available.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Error404 {
 ...
 public enum MessageEnum {
  ...
  public Error404 name(NameEnum name) {
  ...
  **/
  ...
  public Error404 message(MessageEnum message) {
  ...
  **/
  ...
  public Error404 details(List<ErrorDetails> details) {
  ...
  public Error404 addDetailsItem(ErrorDetails detailsItem) {
  ...
  **/
  ...
  public Error404 debugId(String debugId) {
  ...
  **/
  ...
  public Error404 links(List<ErrorLinkDescription> links) {
  ...
  public Error404 addLinksItem(ErrorLinkDescription linksItem) {
    if (this.links == null) {
  ...
  **/
   ...
   * @return the Error404 instance itself
   */
  public Error404 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, error404.name) &&
        Objects.equals(this.message, error404.message) &&
        Objects.equals(this.details, error404.details) &&
        Objects.equals(this.debugId, error404.debugId) &&
        Objects.equals(this.links, error404.links)&&
        Objects.equals(this.additionalProperties, error404.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Error404
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Error404.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Error404>() {
           ...
           public Error404 read(JsonReader in) throws IOException {
             ...
             Error404 instance = thisAdapter.fromJsonTree(jsonObj);

 ...
 */
@ApiModel(description = "The requested action cannot be performed and may require interaction with APIs or processes outside of the current request. This is distinct from a 500 response in that there are no systemic problems limiting the API from performing the request.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Error422 {
  ...
  **/
   ...
   * @return the Error422 instance itself
   */
  public Error422 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, error422.name) &&
        ...
        Objects.equals(this.additionalProperties, error422.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Error422
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Error422.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Error422 is not found in the empty JSON string", Error422.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Error422.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Error422' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Error422> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Error422.class));

       return (TypeAdapter<T>) new TypeAdapter<Error422>() {
           @Override
           public void write(JsonWriter out, Error422 value) throws IOException {
           ...
           @Override
           public Error422 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Error422 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Error422 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Error422
  * @throws IOException if the JSON string is invalid with respect to Error422
  */
  public static Error422 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Error422.class);
  }

 /**
  * Convert an instance of Error422 to an JSON string
  *
  * @return JSON string
  */

 ...
 */
@ApiModel(description = "The authorized payment transaction.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Authorization2 {
  ...
  **/
   ...
   * @return the Authorization2 instance itself
   */
  public Authorization2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, authorization2.status) &&
        ...
        Objects.equals(this.additionalProperties, authorization2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, statusDetails, id, amount, invoiceId, customId, networkTransactionReference, sellerProtection, expirationTime, links, createTime, updateTime, supplementaryData, payee, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Authorization2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Authorization2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Authorization2 is not found in the empty JSON string", Authorization2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Authorization2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Authorization2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Authorization2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Authorization2.class));

       return (TypeAdapter<T>) new TypeAdapter<Authorization2>() {
           @Override
           public void write(JsonWriter out, Authorization2 value) throws IOException {
           ...
           @Override
           public Authorization2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Authorization2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Authorization2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Authorization2
  * @throws IOException if the JSON string is invalid with respect to Authorization2
  */
  public static Authorization2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Authorization2.class);
  }

 /**
  * Convert an instance of Authorization2 to an JSON string
  *
  * @return JSON string
  */

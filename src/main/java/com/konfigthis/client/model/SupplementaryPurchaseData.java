 ...
 */
@ApiModel(description = "The capture identification-related fields. Includes the invoice ID, custom ID, note to payer, and soft descriptor.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SupplementaryPurchaseData {
  ...
  **/
   ...
   * @return the SupplementaryPurchaseData instance itself
   */
  public SupplementaryPurchaseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.invoiceId, supplementaryPurchaseData.invoiceId) &&
        ...
        Objects.equals(this.additionalProperties, supplementaryPurchaseData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invoiceId, noteToPayer, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SupplementaryPurchaseData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SupplementaryPurchaseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupplementaryPurchaseData is not found in the empty JSON string", SupplementaryPurchaseData.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupplementaryPurchaseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupplementaryPurchaseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupplementaryPurchaseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupplementaryPurchaseData.class));

       return (TypeAdapter<T>) new TypeAdapter<SupplementaryPurchaseData>() {
           @Override
           public void write(JsonWriter out, SupplementaryPurchaseData value) throws IOException {
           ...
           @Override
           public SupplementaryPurchaseData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SupplementaryPurchaseData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SupplementaryPurchaseData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SupplementaryPurchaseData
  * @throws IOException if the JSON string is invalid with respect to SupplementaryPurchaseData
  */
  public static SupplementaryPurchaseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupplementaryPurchaseData.class);
  }

 /**
  * Convert an instance of SupplementaryPurchaseData to an JSON string
  *
  * @return JSON string
  */
